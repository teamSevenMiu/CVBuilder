...
object DataService{
    ...
    private fun jhonDoeCV():CV{
        ...
        works.add(WorkExperience(R.drawable.google_icon,"Software Architect","Google","August 2022","Present","CA, USA","Working on different projects"))
        works.add(WorkExperience(R.drawable.apple_icon,"Principle Engineer","Apple","January 2022","August 2022","NY, USA","Working on different projects"))
        works.add(WorkExperience(R.drawable.amazon_icon,"Lead Engineer","Amazon","January 2021","December 2021","TX, USA","Working on different projects"))
        works.add(WorkExperience(R.drawable.microsoft_icon,"Sr. Software Engineer","Microsoft","January 2019","December 2020","IL, USA","Working on different projects"))
        works.add(WorkExperience(R.drawable.netflix_icon,"Software Engineer","Netflix","January 2015","December 2018","IA, USA","Working on different projects"))
